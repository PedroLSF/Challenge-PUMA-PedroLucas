...
const Navbar = ({replace}) => {
  ...
  // Aqui utilizo o useState para armazenar o username digitado e enviar o dado no HOOK para fazer a busca na API
  // Utilizo icone de + para adição e x para exclusão
        ...
        <div className='w-full flex justify-center items-center'>
            <div className='relative'>
                ...
                <input 
                  ...
                  type="name" placeholder='Search to...' 
                  name="username" 
                  className='pl-12 pt-1 pb-1 mr-6 fundoPesquisa border rounded focus:border-none focus:outline focus:outline-blue-500 text-white'
                />
            </div>
            <button onClick={handleSubmit} id="Adder">
